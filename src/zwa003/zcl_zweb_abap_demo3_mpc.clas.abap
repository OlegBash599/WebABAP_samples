class ZCL_ZWEB_ABAP_DEMO3_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_SWITCHONVARDEBUG,
        VARID type string,
    end of TS_SWITCHONVARDEBUG .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZWEB_ABAP_DEMO3_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_ZWEB_ABAP_DEMO3_MPC IMPLEMENTATION.
...
***********************************************************************************************************************************
*   ACTION - SwitchOnVarDebug
***********************************************************************************************************************************

lo_action = model->create_action( 'SwitchOnVarDebug' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'VarH' ). "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'VarID'    iv_abap_fieldname = 'VARID' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZWEB_ABAP_DEMO3_MPC=>TS_SWITCHONVARDEBUG' ). "#EC NOTEXT
  endmethod.
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'VarWithRange' "#EC NOTEXT
                            iv_left_type        = 'VarH' "#EC NOTEXT
                            iv_right_type       = 'VarI' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - VarWithRange
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Name'   iv_dependent_property = 'VarName' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'VarWithRangeSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'VarHSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'VarISet'             "#EC NOTEXT
                                              iv_association_name      = 'VarWithRange' ).                                 "#EC NOTEXT
...
* Navigation Properties for entity - VarH
lo_entity_type = model->get_entity_type( iv_entity_name = 'VarH' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'VarID2Range' "#EC NOTEXT
                                                              iv_abap_fieldname = 'VARID2RANGE' "#EC NOTEXT
                                                              iv_association_name = 'VarWithRange' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'VarH' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSWA003_VAR_H2_SRV'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'VarHSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'VarI' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSWA003_VAR_VAL2_SRV'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'VarISet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210524214852'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'SwitchOnVarDebug'.                                      "#EC NOTEXT
