...
public section.
  ...
  types:
      VARFILEMETA type ZSWA003_FILE_META .
  types:
...
TT_VARI type standard table of TS_VARI .
  types:
     TS_VARFILE type ZSWA003_VAR_FILE_STREAM .
  types:
TT_VARFILE type standard table of TS_VARFILE .
  types:
  begin of TS_VARINFO,
     NAME type C length 30,
     DESCRIPTION type C length 80,
     VAR_TYPE type C length 1,
     VAR_TYPE_TX type C length 20,
     NUM_OF_VALUES type I,
     NUM_OF_FILES type I,
     FILEMETA type VARFILEMETA,
  end of TS_VARINFO .
  types:
TT_VARINFO type standard table of TS_VARINFO .
  types:
  begin of TS_ZSHWA001VARID,
     VAR_NAME type ZEWA001_VAR_NAME,
     VAR_DESC type ZEWA001_VAR_DESC,
     VAR_TYPE type ZEWA001_VAR_TYPE,
     IS_DEL type ZEWA001_VAR_DELETION_MARK,
     IS_DEBUG_ON type ZEWA001_VAR_DEBUG_IS_ON,
     FAST_VAL type ZEWA001_VAR_FAST_VAL,
  end of TS_ZSHWA001VARID .
  types:
TT_ZSHWA001VARID type standard table of TS_ZSHWA001VARID .

  constants GC_VARFILE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'VarFile' ##NO_TEXT.
  constants GC_VARFILEMETA type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'VarFileMeta' ##NO_TEXT.
  ...
  constants GC_VARINFO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'VarInfo' ##NO_TEXT.
  constants GC_ZSHWA001VARID type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Zshwa001Varid' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_VARI
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_VARFILE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_VARINFO
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZSHWA001VARID
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'OptionalPar'    iv_abap_fieldname = 'FREE_USE_PARAM' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   COMPLEX TYPE - VarFileMeta
***********************************************************************************************************************************
lo_complex_type = model->create_complex_type( 'VarFileMeta' ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************
lo_property = lo_complex_type->create_property( iv_property_name  = 'VarName' iv_abap_fieldname = 'VAR_NAME' ). "#EC NOTEXT
...
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1024 ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_complex_type->create_property( iv_property_name  = 'FileSize' iv_abap_fieldname = 'FILE_SIZE' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_complex_type->create_property( iv_property_name  = 'FileMime' iv_abap_fieldname = 'FILE_MIME' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name   = 'ZSWA003_FILE_META'
                                 iv_bind_conversions = 'X' ). "#EC NOTEXT
  endmethod.


  method DEFINE_VARFILE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'VarFile' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ContentDisposition' iv_abap_fieldname = 'CONTENT_DISPOSITION' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FileMime' iv_abap_fieldname = 'FILE_MIME' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSWA003_VAR_FILE_STREAM'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'VafFileSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'VarInfo' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_complex_type = lo_entity_type->create_complex_property( iv_property_name = 'FileMeta'
                                                           iv_complex_type_name = 'VarFileMeta'
                                                           iv_abap_fieldname    = 'FILEMETA' ). "#EC NOTEXT

lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZWEB_ABAP_DEMO3_MPC=>TS_VARINFO' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'VarInfoSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - Zshwa001Varid
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Zshwa001Varid' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'VarDesc' iv_abap_fieldname = 'VAR_DESC' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'IsDebugOn' iv_abap_fieldname = 'IS_DEBUG_ON' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZWEB_ABAP_DEMO3_MPC=>TS_ZSHWA001VARID' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Zshwa001VaridSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210526070047'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'VarFile'.                            "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VarInfo'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'VarType'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VarInfo'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'VarTypeTx'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VarInfo'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'NumOfFiles'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VarInfo'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Zshwa001Varid'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '011'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'VarDesc'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Zshwa001Varid'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'IsDebugOn'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Zshwa001Varid'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'FastVal'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Zshwa001Varid'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'FileName'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                           "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VarFileMeta'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'OptionalPar'.                               "#EC NOTEXT
ls_text_element-artifact_type          = 'FIPA'.                                                "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'FIMP'.                                                "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SwitchOnVarDebug'.                                      "#EC NOTEXT
